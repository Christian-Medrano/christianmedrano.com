	...
	<div class="resume-content">
		<div class="row px-1">
			...
			<div class="col col-6 col-tb-12 px-2 py-2">
				...
				<p>Managing projects, leading and cooperating with design teams, corresponding with clients, writing
project proposals and work orders, drafting invoices, and producing creative solutions for on
campus clients as well as various local and national businesses.</p>
			...
			<div class="col col-6 col-tb-12 px-2 py-2">
				...
				<p>Producing content and graphics for various labels including lyric videos, static videos, motion
...
to promote the various programs and facilities. Assisted with production when necessary.</p>
			...
			<div class="col col-12 col-tb-12 px-2">
				...
				<ul>
					<li><p>University Scholar (2017-2018 Academic Year)</p></li>

					<li><p>Member of the Deans List (2014-2015, 2015-2016, 2016-2017 Academic Years)</p></li>

					<li><p>President of the Student Advertising Graphics Association (SAGA) (Spring 2017)</p></li>

					<li><p>Officer of SAGA (Fall 2016, Fall 2017)</p></li>

					<li><p>Member of Beta Gamma Sigma business honors society</p></li>
				</ul>
			</div>
